...
T poblarArbolIterativo(T (*Generar)(T,T), T neutro, T Arbol [], int sizeArbol, T Inputs[], int sizeInputs, int posicion){
    ...
    if(isLeaf(sizeArbol,posicion)){
        ...
        T valorHijoIzquierdo =
            poblarArbolIterativo(Generar, neutro, Arbol, sizeArbol, Inputs, sizeInputs, getLeftChildren(sizeArbol,posicion));
        T valorHijoDerecho =
            poblarArbolIterativo(Generar, neutro, Arbol, sizeArbol, Inputs, sizeInputs, getRightChildren(sizeArbol,posicion));
